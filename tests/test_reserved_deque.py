...
@pytest.fixture
def default_deque_246() -> ReservedDeque:
    vec = ReservedDeque.with_no_size(3)
    vec.push_back(2)
    vec.push_back(4)
    vec.push_back(6)
...
class TestReservedDeque:
    def test_basic(self, default_deque_246: ReservedDeque):
    ...
    def test_classmethod_from_array(self):
        expected = ReservedDeque.with_no_size(3)
        expected.push_back(123)
        expected.push_back(456)
        expected.push_back(789)

        actual = ReservedDeque.with_size([123, 456, 789])

        assert expected == actual

    def test_push_back_matches_pop_back(self, default_deque_246: ReservedDeque):
        assert default_deque_246.pop_back() == 6
        assert default_deque_246.pop_back() == 4
        assert default_deque_246.pop_back() == 2

    def test_push_back_matches_pop_front(self, default_deque_246: ReservedDeque):
        assert default_deque_246.pop_front() == 2
        assert default_deque_246.pop_front() == 4
        assert default_deque_246.pop_front() == 6

    def test_pop_front_then_pop_back(self, default_deque_246: ReservedDeque):
        assert default_deque_246.pop_front() == 2
        assert default_deque_246.pop_back() == 6
        assert default_deque_246.pop_front() == 4

    def test_pop_back_then_pop_front(self, default_deque_246: ReservedDeque):
        assert default_deque_246.pop_back() == 6
        assert default_deque_246.pop_front() == 2
        assert default_deque_246.pop_back() == 4

    def test_pop_front_then_push_front(self, default_deque_246: ReservedDeque):
        assert default_deque_246.pop_front() == 2
        default_deque_246.push_front(123)
        assert default_deque_246.pop_front() == 123

    def test_raises_push_back_too_many(self, default_deque_246: ReservedDeque):
        with pytest.raises(IndexError):
            default_deque_246.push_back(8)

    def test_raises_pop_back_too_many(self, default_deque_246: ReservedDeque):
    ...
    def test_raises_pop_front_too_many(self, default_deque_246: ReservedDeque):
    ...
    def test_max_size(self):
        max_size = 3
        deque = ReservedDeque.with_no_size(max_size)
    ...
    def test_size_with_push_back_and_pop_front(self):
        deque = ReservedDeque.with_no_size(10)
        deque.push_back(1)
        deque.push_back(2)
        deque.push_back(3)
        deque.pop_front()
